...
function VerifyForm(props) {
    ...
    const [data, setData] = useState({
        apiKey: localStorage.getItem('Authorization'),
        cucKey: localStorage.getItem('cuc_key'),
    ...
    useEffect(() => {
        //console.log("in verify form, cuckey=" + data.cucKey)
    ...
    return (
        <div className="form_content">
            <div className="form_div">
                <form>
                    <label>
                        ...
                        <input type="text" value={data.apiKey} onChange={(e) => {
                    ...
                    <label>
                        ...
                        <input className={isCucKey ? 'non-filled-input' : ''} type="text" value={data.cucKey} onChange={(e) => {
                            localStorage.setItem("cuc_key", e.target.value);
            ...
            <div className="btns">
                <div className="btn verify_btn" onClick={() => handleVerify()}>
                    Next
                </div>
            </div>
        </div>
