...
function EnrollForm(props) {
    ...
    const handleEnroll = (type) => {
        ...
        console.log("enroll data api key=" + enrollData.apiKey + ",cuckey=" + enrollData.cucKey)
            ...
            <div className="form_div">
                <form>
                    <label>
                        ...
                        <input className={isApiKey ? 'non-filled-input' : ''} type="text" value={enrollData.apiKey} onChange={(e) => {
